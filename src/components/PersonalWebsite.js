import PersonalWebsite1 from "../img/personalWebsite1.png"
import PersonalWebsite2 from "../img/personalWebsite2.png"
...
const PersonalWebsite = () => {
    ...
    const ButtonOnClickHandler = (target = "") => {
        ...
        switch (target) {
            case "Github":
                path = "https://github.com/redfrogsss/redfrogss.dev";
                break;
            default:
                break;
        }
    ...
    const ProjectImage = () => {
        if (isSafari || isChrome) {
            return <img class="object-cover w-[100%]" src={PersonalWebsite1} alt="Screenshot of redfrogss.dev"></img>
        } else {
            return <Carousel />
        }
    }
    ...
    const Carousel = () => {
        // This component does not support safari and chrome
        return (
            <div className="w-[100%]">
                <div id="default-carousel" class="relative" data-carousel="static">
                    <div class="overflow-hidden relative h-56 rounded-lg sm:h-64 xl:h-80 2xl:h-96">
                        ...
                        <div class="hidden duration-700 ease-in-out" data-carousel-item>
                            ...
                            <img src={PersonalWebsite1} class="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="..." />
                        </div>
                        {/* <!-- Item 2 --> */}
                        <div class="hidden duration-700 ease-in-out" data-carousel-item>
                            <img src={PersonalWebsite2} class="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="..." />
                        </div>
                    </div>
                    {/* <!-- Slider indicators --> */}
        ...
        <>
            <div class="grid grid-cols-1 lg:grid-cols-2 p-2.5 md:p-6 bg-slate-800 rounded-lg border border-slate-400 shadow-md">
                <div class="flex lg:hidden">
                    <img class="object-cover w-[100%]" src={PersonalWebsite1} alt="Screenshot of SelfRemind"></img>
                </div>
                <div class="md:pl-2 px-0 md:px-8">
                    <h1 className="text-2xl font-bold font-mono">Personal Website (redfrogss.dev)</h1>
                    ...
                    <p>
                        <text className="text-lg pt-4 font-mono">
                            redfrogss.dev - My Personal Website built with ReactJS, TailWindCSS and Three.JS.
